...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style>
        ...
        td {  text-align: center; background: #eeeeee; font-size: 8pt; padding: 8px 2px; width: 2.8%;}
        tr { }
...
<asp:Content ID="ContentBar" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1><a href="/default.aspx"><i class="fa fa-battery-full" aria-hidden="true"></i> 12V PV Charging Max Current</a></h1>    
