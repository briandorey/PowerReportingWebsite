...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            SqlDataSource1.SelectCommand = "SELECT AVG(watertop) AS watertop, AVG(waterbase) AS waterbase, AVG(waterpanel) AS waterpanel, AVG(TempLivingRoom) AS hometemp, AVG(solarc) AS solarc, AVG(offgridc) AS offgridc, AVG(batteryv) AS batteryv,  DATEPART(mm, eDate) AS DateMonth, DATEPART(yyyy, eDate) AS DateYear FROM   dbo.HomeLogGeneral GROUP BY DATEPART(mm, eDate), DATEPART(yyyy, eDate) order by DateYear asc, DateMonth asc";
            Repeater1.DataBind();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1><a href="/default.aspx"><i class="fa fa-calendar" aria-hidden="true"></i> Monthly Average Report</a></h1>
