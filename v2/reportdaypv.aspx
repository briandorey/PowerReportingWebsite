...
<script runat="server">
    ...
    public void setdata(DateTime dt){
            ...
            // pv data
            SqlDataSourcePV.SelectCommand = "SELECT TOP (100) AVG(solarc) AS solarc, DATEPART(hh, eDate) AS Hour , DATEPART(minute, dateadd(minute,(datediff(minute,0,eDate)/15)*15,0)) AS MinVal FROM dbo.HomeLogGeneral  WHERE  eDate > '" + dt.ToString("s") + "' GROUP BY dateadd(minute,(datediff(minute,0,eDate)/15)*15,0),  DATEPART(dw, eDate), DATEPART(hh, eDate), DATEPART(dd, eDate), DATEPART(mm, eDate), DATEPART(yyyy, eDate)";
            Repeater2.DataBind();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1><a href="/default.aspx"><i class="fa fa-clock-o" aria-hidden="true"></i> Data for last 3 Hours</a></h1> 
